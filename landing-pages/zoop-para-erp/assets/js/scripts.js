...
$(function() {
    $('#typed').typed({
        strings: ["custo de setup", "mensalidade", "tarifas de cancelamento", "tarifas por usuário", "taxas ocultas", "taxas recorrentes", "burocracia"],
        typeSpeed: 30,
        loop: true,
        backSpeed: 20,
        backDelay: 500
...
$(document).ready(function() {
    ...
    $('#enviar').click(function() {
        ...
        var identificador = 'zoop-para-erp';
        ...
        var areaatuacao = $("select[name='areaatuacao']" );
        ...
        if (!nome.val()){
        ...
        } else if (areaatuacao.val() == 'nulo'){
            Swal.fire({
                icon: 'warning',
                title: 'Campo obrigatório',
                text: 'Informe sua área',
                timer: 2000,
                onAfterClose: () => {
                    areaatuacao.focus();
                }
        ...
        } else if (area.val() == 'Pagamenttos' && transacionado.val() == 'nulo') {
            Swal.fire({
                icon: 'warning',
                title: 'Campo obrigatório',
            ...
            var sendRD = [
                ...
                { name: 'Área', value: areaatuacao.val()},
...
$('#playvideo').click(function(){
    ...
    $('body > div > iframe').attr("src","https://www.youtube.com/embed/fY8KoI_J-KY?autoplay=1");;
});
