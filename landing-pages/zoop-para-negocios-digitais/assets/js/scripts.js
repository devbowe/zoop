$(document).ready(function(){
    if (screen.width < 767) {
        $(".listamobile").not('.slick-initialized').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            centerPadding: '0',
            centerMode: true,
...
$(document).ready(function(){
    $(".lista").not('.slick-initialized').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        centerPadding: '0',
        centerMode: true,
...
$(document).ready(function(){
    ...
    $("select").change(function(){
        ...
        if (area == 'Pagamentos') {
            ...
            $("select[name='contas']" ).hide();
            $("select[name='transacionado']" ).css("width", "97%");
        }
        if (area == 'Banking'){
            $("select[name='transacionado']" ).hide();
            $("select[name='contas']" ).fadeIn();
            $("select[name='contas']" ).css("width", "97%");
        }
        if(area == 'Pagamentos/Banking'){
            $("select[name='transacionado']" ).fadeIn();
            $("select[name='contas']" ).fadeIn();
            $("select[name='transacionado']" ).css("width", "47%");
            $("select[name='contas']" ).css("width", "47%");
        }
    });

    $("select[name='contas']").change(function(){
        $("select[name='dev-proprio']").fadeIn();            
        $("select[name='dev-proprio']" ).css("width", "97%");
    });
    
    $("select[name='transacionado']").change(function(){
        $("select[name='ajuda']").fadeIn();            
        $("select[name='ajuda']" ).css("width", "97%");
        $("input[name='sujestao']").fadeIn();            
        $("input[name='sujestao']").css("width", "94%");
    });
    ...
    function transition() {
        ...
        if(count == 1) {
            $('#section03').css('background-color','#7300FF');
            count = 2;

        } else if(count == 2) {
            $('#section03').css('background-color','#FF0064');
            count = 3;

        } else if(count == 3) {
            $('#section03').css('background-color','#FF9B00');
            count = 1;
...
$(function() {
    $('#typed').typed({
        strings: ["reduzir custos com terceiros","surpreender seus clientes", "entender os consumidores", "fortalecer a marca"],
        typeSpeed: 30,
        loop: true,
        backSpeed: 20,
        backDelay: 500
...
$("input[name='sobrenome']" ).keypress(function(e) {
    var keyCode = (e.keyCode ? e.keyCode : e.which); // Variar a chamada do keyCode de acordo com o ambiente.
    if (keyCode > 47 && keyCode < 58) {
    e.preventDefault();
    }
...
$("input[name='sobrenome']" ).on('input', function() {
    $(this).val($(this).val().replace(/[^a-z0-9]/gi, ''));
});
...
$(document).ready(function() {
    ...
    $('#enviar').click(function() {
        ...
        var identificador = 'zoop-negocios-digitais';
